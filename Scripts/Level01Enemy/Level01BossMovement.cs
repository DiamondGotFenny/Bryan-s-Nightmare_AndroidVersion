...
public class Level01BossMovement : MonoBehaviour {
   ...
   public NavMeshAgent nav;
    ...
    void animControl()
    {
        ...
        if (enemyHealth.currentHealth > 0&&playerHealth.currentHealth>0)
        {
            ...
            if (Vector3.Distance(playerTran.position,this.transform.position)<10&&skillTimer>skillCD)
            {
                skillTimer = 0;
                nav.enabled = false;
    ...
    void skillInstantiate()
    {
        ...
        skill.transform.position = new Vector3( this.transform.position.x,this.transform.position.y+1,this.transform.position.z);
